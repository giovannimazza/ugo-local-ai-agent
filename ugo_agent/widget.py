...
_WSTR = {
    "it": {
        ...
        "understand": "Capisco, un attimo…",
        "i_listen": "\U0001F3A4 Ti ascolto…",
        "nothing": "Non ho sentito nulla. Riprova.",
        "nothing_rec": "Non ho registrato nulla.",
        "mic_error": "Problema col microfono: {e}",
        "server_error": "Non raggiungo il server: {e}",
        "error": "Errore: {e}",
        "starting": "Avvio il server…",
        "ready": "Pronto.",
        "srv_down": "Server non raggiungibile.",
        "voice_off": "Voce disattivata.", "voice_on": "Voce riattivata.",
        "listen_off": "Ascolto passivo spento.",
    ...
    "en": {
        ...
        "understand": "Got it, one moment…",
        "i_listen": "\U0001F3A4 I'm listening…",
        "nothing": "I didn't catch that. Try again.",
        "nothing_rec": "Nothing was recorded.",
        "mic_error": "Microphone problem: {e}",
        "server_error": "Can't reach the server: {e}",
        "error": "Error: {e}",
        "starting": "Starting the server…",
        "ready": "Ready.",
        "srv_down": "Server unreachable.",
        "voice_off": "Voice muted.", "voice_on": "Voice unmuted.",
        "listen_off": "Passive listening off.",
        "listen_on": "Passive listening on: just say “Ugo”.",
